...
$album=new Album($con);
$details=$album->getNormalAlbumDetail();
...
if(isset($_GET['current']))
{
    ...
    if($updateResult)
    {
      ...
      header('location:normalalbum.php?updated=true&val='.$curr.'');
...
?>
<div class="container">
    <h1> This user has Normal Membership</h1>
    <?php 
if(isset($_SESSION['email']) && $_SESSION['email'] == "sinhaamit553@gmail.com")
{

  echo '<a class="btn btn-danger my-4" href="addalbum.php?albumType=0">Create New Album</a>';
}
?>
...
<div class="card mx-1" style="width: 18rem;">
  <img src="../upload/'.$detail['albumimage'].'" height="200px" class="card-img-top" alt="">
  <div class="card-body">
